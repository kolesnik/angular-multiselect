    ...
    .factory('optionParser', ['$parse', function ($parse) {
        ...
        return {
            parse: function (input) {
                ...
                if (!match) {
                    throw new Error(
                            "Expected typeahead specification in form of '_modelValue_ (as _label_)? " +
            ...
            return {
                ...
                link: function (originalScope, element, attrs, modelCtrl) {
                    ...
                    scope.$watch(function () {
                        ...
                        // But we don't want to do this every time model changes.
                        // We need to do this only if it is done outside directive scope, from controller, for example.
                        if (angular.isDefined(newVal)) {
                            markChecked(newVal);
